...
Router::get('/institucional/npor/cancao', fn() => (new InstitucionalController())->cancaoNpor());
Router::get('/institucional/npor/brasao', fn() => (new InstitucionalController())->brasaoNpor());
Router::get('/institucional/npor/historico', fn() => (new InstitucionalController())->historicoNpor());
