...
class InstitucionalController extends Controller
{
    ...
    public function brasao(): void
    {
        $this->renderPage('brasao', [
            ...
            'media' => [
                'type' => 'image',
                'src' => BASE_URL . 'assets/images/brand/aore1.webp',
                'alt' => 'Selo oficial da AORE/RN',
                'caption' => 'Utilizar apenas versões autorizadas pela Diretoria de Comunicação Social.',
                'download_url' => BASE_URL . 'assets/images/brand/aore1.png',
                'download_name' => 'aore1.png',
                'download_label' => 'Download da marca (PNG)',
                'download_png_url' => BASE_URL . 'assets/images/brand/aore1.webp',
                'download_png_name' => 'aore1.webp',
                'download_png_label' => 'Download da marca (WEBP)',
                'download_png_icon' => 'bi-file-earmark-image',
                'download_png_aria_label' => 'Baixar imagem WEBP otimizada do selo da AORE/RN',
            ],
            'resources' => [
